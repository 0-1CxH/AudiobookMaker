...
**AudiobookMaker 是一个基于AI的有声书制作工具，能够自动化处理文本到音频的转换流程。通过智能化的角色提取、对话分配、语音设计和音频合成能力，帮助用户快速、低成本（$0.35/万字）制作高质量的有声书内容。**
...
使用如下配置和成本单价：
- Azure GPT-4o API 按输入$0.178/1M token，输出$0.714/1M token计
- Qwen3 TTS 由本地RTX4080S GPU部署，按$0.078/GPU hour计
...
| 参考语音 | 185 (GPU seconds) | $0.0040 |
| 语音片段 | 660 (GPU seconds) | $0.0143 |
| **总计** | | **$0.0602** |
...
| 参考语音 | 219 (GPU seconds) | $0.0047 |
| 语音片段 | 5745 (GPU seconds) | $0.1245 |
| **总计** | | **$0.2775** |
